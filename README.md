...
## How to use?
Include <strong>JsonMap.hpp</strong> to your project (you can find it in the source folder), link JsonMap.lib to your project(you can find it in the lib folder or compile it yourself).</br>
